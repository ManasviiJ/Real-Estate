...
tb.Label(sf2,text="SELL OR LEASE:",font=("Helvetica",12)).grid(row=0,column=0,pady=10,sticky=W)

selected_option = tk.StringVar()

sell = tk.Radiobutton(sf2, text="SELL", variable=selected_option, value="SELL")
sell.grid(row=0, column=1)

lease = tk.Radiobutton(sf2, text="LEASE", variable=selected_option, value="LEASE")
lease.grid(row=0, column=2)

tb.Label(sf2,text="PROPERTY TYPE:",font=("Helvetica",12)).grid(row=1,column=0,pady=10,sticky=W)

# Creating a list of days for the dropdown
prop_type = ["Residential Property", "Commercial/Industrial Property", "Land/Plot"]

# Creating a combobox (dropdown menu)
my_combo = tb.Combobox(sf2, bootstyle="primary", values=prop_type)
my_combo.grid(row=1,column=1,columnspan=2)

#new frame inside sf2:property det frame
Prop_dets_frame= tk.LabelFrame(sf2, text="PROPERTY DETAILS", font=("Helvetica", 12), padx=10)
Prop_dets_frame.grid(row=2, column=0,columnspan=3, padx=10, pady=10)

tb.Label(Prop_dets_frame,text="Location:",font=('Helvetica',12)).grid(column=0,row=0,sticky=W)
my_combo2 = tb.Combobox(Prop_dets_frame, bootstyle="primary", values=search_options)
my_combo2.grid(row=0,column=1,columnspan=2)

tb.Label(Prop_dets_frame,text="Address:",font=('Helvetica',12)).grid(column=0,row=1,sticky=W)
address = tb.Entry(Prop_dets_frame)
address.grid(row=1,column=1,columnspan=2,sticky=E)

tb.Label(Prop_dets_frame,text="Title:",font=('Helvetica',12)).grid(column=0,row=2,sticky=W)
title = tb.Entry(Prop_dets_frame)
title.grid(row=2,column=1,columnspan=2,sticky=E)
                               
tb.Label(Prop_dets_frame,text="No of rooms (BHK):",font=('Helvetica',12)).grid(column=0,row=3,sticky=W)
bhk = tb.Entry(Prop_dets_frame)
bhk.grid(row=3,column=1,columnspan=2,sticky=E)

tb.Label(Prop_dets_frame,text="Area sqft:",font=('Helvetica',12)).grid(column=0,row=4,sticky=W)
area = tb.Entry(Prop_dets_frame)
area.grid(row=3,column=1,columnspan=2,sticky=E)

tb.Label(Prop_dets_frame,text="Furnishing details:",font=('Helvetica',12)).grid(column=0,row=5,sticky=W)
furnish=["Unfurnished","Semi-Furnished","Fully-Furnished"]
my_combo3 = tb.Combobox(Prop_dets_frame, bootstyle="primary", values=furnish)
my_combo3.grid(row=5,column=1,columnspan=2)

tb.Label(Prop_dets_frame,text="Parking Availabilty",font=('Helvetica',12)).grid(column=0,row=6,sticky=W)
Yes = tk.Radiobutton(Prop_dets_frame, text="YES", variable=selected_option, value="YES")
No = tk.Radiobutton(Prop_dets_frame, text="NO", variable=selected_option, value="NO")

tb.Label(Prop_dets_frame,text="Age of Property",font=('Helvetica',12)).grid(column=0,row=7,sticky=W)
prop_age = tb.Entry(Prop_dets_frame)
prop_age.grid(row=7,column=1,columnspan=2,sticky=E)

tb.Label(Prop_dets_frame,text="Description",font=('Helvetica',12)).grid(column=0,row=8,sticky=W)
desc = tb.Entry(Prop_dets_frame, width=150)
desc.grid(row=8,column=1,columnspan=2,sticky=E)
